...
uci set network.lan.gateway='172.16.10.2'                                   # IPv4 网关
...
sed -i "s/OpenWrt /OpenWrt_x64_精简版 by GXNAS build $(TZ=UTC-8 date "+%Y.%m.%d") @ OpenWrt /g" $ZZZ           # 增加个性名字 ${Author} 默认为你的github帐号
